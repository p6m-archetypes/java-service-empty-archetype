-- Java Service Platform Overlay ("empty" archetype).
--
...
--
--   archetect render .../java-service-empty-archetype /path/to/existing-project
--
...
-- No Maven group_id prompt: nothing the overlay renders (CI, Dockerfiles,
-- platform manifests) references it. The full java-rest archetype prompts for
-- group_id/artifactory_host to scaffold poms and Java source — none of which
-- this overlay carries — so prompting here would be noise.
