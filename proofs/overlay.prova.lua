--- The p6m overlay standards (E1–E7), held against the Java "empty" archetype — a platform
...
local VARIANTS = {
  ...
  },
  {
    ...
    runtime_artifact = "app/build/libs/legacy.jar",
  },
}
...
prova.group("java-empty: the archetype itself", { tags = { "standards" } }, function(g)
